...
Source: `global-embeds/logo-wall/logo-wall.js` (**v1.59.230**) · companion stylesheet:
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/the-starters/starters-webflow@v1.59.230/global-embeds/logo-wall/logo-wall.css">
```

```html
<script defer src="https://cdn.jsdelivr.net/gh/the-starters/starters-webflow@v1.59.230/global-embeds/logo-wall/logo-wall.js"></script>
```
