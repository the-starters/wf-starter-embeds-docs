...
branching flow — and every arrow is driven by an attribute, no custom JS. Edge colors match
...
Click through it below — the left pane is the rendered flow, the right pane shows which
